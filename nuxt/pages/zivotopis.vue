<template>
  <div class="flex-card-layout grid-card-layout">
    <!-- 1 Nadpis -->
    <div class="full-card grid-full-card">
      <div class="card-body">
    ...
    <div class="small-card grid-small-card">
      <div class="card-body">
        <h2 class="card-title text-secondary">Hledam praci jako:</h2>
        <p>backend, frontend, fullstack junior developer</p>
      </div>
    </div>
    <!-- 3 souhrn -->
    <div class="large-card grid-large-card">
      <div class="card-body">
    ...
    <div class="small-card grid-small-card">
      <div class="card-body">
        ...
        <div class="grid grid-cols-[min-content_min-content] gap-x-4">
          <span>email: </span>  <a class="link link-accent" href="mailto:daniel_sykora@icloud.com">daniel_sykora@icloud.com</a>
          <span>tel: </span>    <a class="link link-accent" href="tel:+420603328223">603 328 223</a>
        </div>
      </div>
    </div>
    <!-- Soft skills -->
    <div class="large-card grid-large-card">
      <div class="card-body">
        ...
        <div class="flex flex-col  gap-4">
          <p><b class="whitespace-nowrap text-lg">odolný vůči stresu:</b> jako kurýr jsem pracoval pod tlakem a mnohdy řešil více věcí najednou </p>
          <p><b class="whitespace-nowrap text-lg">úhel pohledu:</b>       často dokážu vidět věci z různých pohledů a na základě toho poskytovat zpětnou vazbu </p>
          <p><b class="whitespace-nowrap text-lg">důslednost:</b>         při řešení problémů mě zajímá hlavně jak problém vznikl ne jenom jak ho vyřešit </p>
        </div>
      </div>
    </div>
    <!-- Technologie -->
    <div class="small-card grid-small-card">
      <div class="card-body">
        ...
        <div class="grid grid-cols-[min-content_min-content] gap-x-8 gap-y-2">
          <span class="flex flex-nowrap">python     <icon-technology-python class=" ml-2 w-4 h-4 self-center"/> </span>
          <span class="flex flex-nowrap">javascript <icon-technology-javascript class=" ml-2 w-4 h-4 self-center"/></span>
          <span class="flex flex-nowrap">HTML       <icon-technology-html class=" ml-2 w-4 h-4 self-center"/></span>
          <span class="flex flex-nowrap"><i>CSS </i><icon-technology-css class=" ml-2 w-4 h-4 self-center"/></span>
          <span class="flex flex-nowrap">FastAPI    <icon-technology-fastapi class=" ml-2 w-4 h-4 self-center"/></span>
          <span class="flex flex-nowrap">Vue        <icon-technology-vue class=" ml-2 w-4 h-4 self-center"/></span>
        </div>
      </div>
    </div>
    <!-- Vzdelani -->
    ...
    <div class="small-card grid-small-card">
      <div class="card-body">
        <h2 class="card-title text-secondary">Byvale prace:</h2>
        <div class="grid grid-cols-[min-content_min-content_min-content] gap-x-8 gap-y-2">
          <b>Rohlik</b> <span>kurýr</span> <span class=" whitespace-nowrap">nyní</span>  
          <b>GLS</b>    <span>kurýr</span> <span class=" whitespace-nowrap">4 roky</span> 
          <b>Tint</b>   <span>montér</span><span class=" whitespace-nowrap">1 rok</span> 
        </div>
      </div>
    </div>
...
<style>
.grid-card-layout{
  @apply grid gap-4 w-full mx-auto grid-cols-[repeat(auto-fit,minmax(280px,1fr))] grid-flow-dense;
}
.grid-full-card{
  @apply card shadow-xl bg-base-100 hover:opacity-90 col-span-full;
}
.grid-small-card{
  @apply card shadow-xl bg-base-100 hover:opacity-90;
}
.grid-large-card{
  @apply card shadow-xl bg-base-100 hover:opacity-90 md:col-span-2 row-span-2;
}

/* .flex-card-layout{
  @apply flex flex-row flex-wrap gap-4 max-w-4xl mx-auto;
}
.full-card{
  @apply card shadow-xl bg-base-200 min-w-full hover:opacity-90;
}
.small-card{
